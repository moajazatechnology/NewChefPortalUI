...
import { ViewSingleOrderChefComponent } from './order/view-single-order-chef/view-single-order-chef.component';
    ...
    component: AdminComponent,
      children : [
        ...
        },
        {
          ...
          component: ViewSingleOrderChefComponent
        },
        {
          path : 'product',
