...
@Component({
  selector: 'app-view-single-order-chef',
  templateUrl: './view-single-order-chef.component.html',
  styleUrls: ['./view-single-order-chef.component.scss']
})
export class ViewSingleOrderChefComponent implements OnInit {
  id: number = 0;
  orderData: any = {};
  ...
  ngOnInit(): void {
    ...
    this.chef_id = localStorage.getItem("chef_Id");
